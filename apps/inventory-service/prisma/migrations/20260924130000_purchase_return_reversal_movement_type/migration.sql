-- Phase 3.6 (Purchase Return reversal) — adds PURCHASE_RETURN_REVERSAL as a
-- new StockMovementType. Purely additive — no new column or table: the
...
-- AlterEnum
ALTER TYPE "StockMovementType" ADD VALUE 'PURCHASE_RETURN_REVERSAL';
